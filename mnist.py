...
###Using boilerplate code given from CSE 575 Class
def parse_idx(fd):
    ...
    try:
        ...
        raise DecodeError('Unknown data type 0x%02x in IDX file' % data_type)
    ...
    if len(data) != expected_items:
        raise DecodeError('IDX file has wrong number of items. '
